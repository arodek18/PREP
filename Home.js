...
import { Animated,Platform, StyleSheet, Text, View, TouchableOpacity, Image, StatusBar} from 'react-native';
...
: null }
   ...
   { this.state.loderview ?
               ...
               justifyContent: 'center'}}>
                      ...
                      <Spinner isVisible={!this.state.loderview} size={80} type={'Circle'} color={"#031537"}/>
